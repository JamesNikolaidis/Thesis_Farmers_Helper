...
public class Close_Program_Dialog {
        ...
        public void CloseProgramDialog(final Activity activity , int Language){
                    ...
                    .setPositiveButton(activity.getResources().getString(R.string.ExitYesMessageGr), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                           activity.finishAffinity();
                            activity.getSharedPreferences("Data",Context.MODE_PRIVATE).edit().remove("Data").commit();
    ...
    public void GoToMainPanelDialog(final Activity activity ,String Message,String Negative,String Positive){
        final AlertDialog.Builder mCloseAppDialogBuilder = new AlertDialog.Builder(activity);
